...
mv visdial_1.0_train.json data/
...
# python evaluate.py --config-yml configs/lf_disc_faster_rcnn_x101_bs32.yml --use-gt true --load-pthpath checkpoints/checkpoint_19.pth

# Run eval on test
# python evaluate.py --config-yml configs/lf_disc_faster_rcnn_x101_bs32.yml --use-gt false --load-pthpath checkpoints/checkpoint_19.pth --eval-json data/visdial_1.0_test.json